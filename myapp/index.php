	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form action="Controllers/UController.php" method="post" class="login100-form validate-form">
    ...
    <script>
        ...
        if (error === 'login_failed') {
            ...
            toast({
                ...
                content: "Your password is invalid, possibly too short",
                typeicon: "error",
                duration: 8000 
            })  
        }
            ...
            toast({
                title: "Empty data",
                content: "Please fill in the information",
                typeicon: "error",
                duration: 8000 
            })  
        }
